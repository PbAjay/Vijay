...
def song(client, message):
    ...
    try:
        ...
        m.edit(
            "**ɴᴏᴛʜɪɴɢ ғᴏᴜɴᴅ ᴘʟᴇᴀsᴇ ᴄᴏʀʀᴇᴄᴛ ᴛʜᴇ sᴘᴇʟʟɪɴɢ ᴏʀ sᴇᴀʀᴄʜ ᴀɴʏ ᴏᴛʜᴇʀ sᴏɴɢ**"
        )
        print(str(e))
        return
    ...
    try:
        ...
        rep = '**ʙʏ›› [ᴄʀᴜᴅᴇ_x](https://t.me/Crude_X)**'
...
async def vsong(client, message: Message):
    ...
    pablo = await client.send_message(
        message.chat.id, f"**ғɪɴᴅɪɴɢ ʏᴏᴜʀ ᴠɪᴅᴇᴏ** `{urlissed}`"
    )
    if not urlissed:
    ...
    try:
        ...
        await event.edit(event, f"**ᴅᴏᴡɴʟᴏᴀᴅ ғᴀɪʟᴇᴅ ᴘʟᴇᴀsᴇ ᴛʀʏ ᴀɢᴀɪɴ..♥️** \n**ᴇʀʀᴏʀ :** `{str(e)}`")
        return
    c_time = time.time()
