...
async def deletefilter(client, message):
    ...
    try:
        ...
        await message.reply_text(
            "<i>ᴍᴇɴᴛɪᴏɴ ᴛʜᴇ ғɪʟᴛᴇʀɴᴀᴍᴇ ᴡʜɪᴄʜ ʏᴏᴜ ᴡᴀɴᴛ ᴅᴇʟᴇᴛᴇ</i>\n\n"
            "<code>/ᴅᴇʟᴇᴛᴇ ғɪʟᴛᴇʀ ɴᴀᴍᴇ</code>\n\n"
            "Use /viewfilters ᴛᴏ ᴠɪᴇᴡ ᴀʟʟ ᴀᴠᴀɪʟᴀʙʟᴇ ғɪʟᴛᴇʀs",
            quote=True
        )
        return
...
async def delallconfirm(client, message):
    ...
    if (st.status == "creator") or (str(userid) in ADMINS):
        await message.reply_text(
            f"ᴛʜɪs ᴡɪʟʟ ᴅᴇʟᴇᴛᴇ ᴀʟʟ ғɪʟᴛᴇʀᴀ ғʀᴏᴍ '{title}'.\nᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ??",
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton(text="ʏᴇs",callback_data="delallconfirm")],
                [InlineKeyboardButton(text="ɴᴏ",callback_data="delallcancel")]
            ]),
            quote=True
        )
