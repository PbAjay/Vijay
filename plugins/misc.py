...
async def aboutme(client, message):
        buttons= [[
            InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url='https://t.me/MalluHubYT')
            ],[
...
async def imdb_search(client, message):
    if ' ' in message.text:
        ...
        if not movies:
            return await message.reply("ɴᴏ ʀᴇsᴜʟᴛ ғᴏᴜɴᴅ")
        btn = [
            [
        ...
        await message.reply('ɢɪᴠᴇ ᴍᴇ ᴀ ᴍᴏᴠɪᴇ ᴏʀ sᴇʀɪᴇs ɴᴀᴍᴇ')
